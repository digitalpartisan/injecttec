Scriptname InjectTec:Utility:Logger Hidden Const DebugOnly
...
Bool Function revertingLeveled(Form fTarget) Global
	return log("reverting leveled item: " + fTarget)
EndFunction

Bool Function logRevertingArray(Form fTarget, Form[] faRemovals) Global
